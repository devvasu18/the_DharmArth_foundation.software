                                    ...
                                    <div style={{ display: 'flex', gap: '8px', width: '100%', flexWrap: 'wrap', backgroundColor: '#ffffff', padding: '12px', borderRadius: '8px', border: errors.includes(index) ? '1px solid #ef4444' : 'none' }}>
                                        ...
                                        <div className="input-group-p" style={{ flex: 1, minWidth: '120px' }}>
                                            ...
                                            {item.batches && item.batches.length > 0 ? (
                                                ...
                                                <input type="text" value={item.margBatch || ''} onChange={(e) => handleItemChange(index, 'margBatch', e.target.value)} style={{ padding: '8px', borderRadius: '6px', border: '1px solid #cbd5e0', width: '100%', fontSize: '0.85rem' }} placeholder="Batch No"/>
                                            )}
                                        </div>
                                        <div className="input-group-p" style={{ flex: 1, minWidth: '120px' }}>
                                            <label style={{ fontSize: '0.75rem' }}>Expiry</label>
                                            <input type="month" value={item.margExpiry ? item.margExpiry.substring(0, 7) : ''} onChange={(e) => handleItemChange(index, 'margExpiry', e.target.value)} style={{ padding: '8px', borderRadius: '6px', border: '1px solid #cbd5e0', width: '100%', fontSize: '0.85rem' }}/>
                                        </div>
                                        <div className="input-group-p" style={{ flex: 1, minWidth: '100px' }}>
                                            <label style={{ fontSize: '0.75rem' }}>Bill No (VCN)</label>
                                            <input type="text" value={item.margBillNo || ''} onChange={(e) => handleItemChange(index, 'margBillNo', e.target.value)} style={{ padding: '8px', borderRadius: '6px', border: '1px solid #cbd5e0', width: '100%', fontSize: '0.85rem' }} placeholder="Auto/Man"/>
                                        </div>
