...
router.get('/admin/amounts', protect, adminOnly, subscriptionController.getUniqueAmounts);
router.post('/request-cancel-otp/:id', protect, subscriptionController.requestCancelSubscriptionOTP);
